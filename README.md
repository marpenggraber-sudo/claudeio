...
1.用户点击右上角后进入登录页，输入账号密码登陆后自动跳到首页，同时右上角要显示“My”
2.登录状态下，右上角点击“My”，进入一个风格相符的页面，有“退出登录”和“更新cookies”功能
3.点击歌曲标题处进入歌词页
4.在歌词页左滑可以进入历史记录
5.输入文字的时候页面压缩不优雅，点击后除第一栏外，动画平滑退入顶部，形成类似聊天页面
6.播放ui大小调整，音量调整可考虑透明隐匿方式条，文字显示调整
7.增加语音功能
